...
export declare function RainbowKitProvider({ appInfo, avatar, chains, children, coolMode, id, initialChain, modalSize, showRecentTransactions, theme, }: RainbowKitProviderProps): JSX.Element;
