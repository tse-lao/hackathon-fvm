...
*/
contract LilypadEventsUpgradeable is
    Initializable,
    ...
    UUPSUpgradeable
{
    ...
    function setEscrowMinAutoPay(
        uint256 _minAmount
    ) public onlyRole(UPGRADER_ROLE) {
        escrowMinAutoPay = _minAmount;
    }

    function setEscrowWalletAddress(
    ...
    function withdrawBalanceToEscrowAddress() public onlyRole(UPGRADER_ROLE) {
        require(
            ...
            'No money in contract able to be withdrawn'
        );
    ...
    function runLilypadJob(
        ...
        require(
            msg.value >= LILYPAD_FEE,
            'Not enough payment sent to cover job fee'
        );
